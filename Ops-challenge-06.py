...
def encrypt_file(file_path, key):
    ...
    changed_data = cipher_suite.encrypt(data)  # This encrypts the file content
    with open(file_path, 'wb') as file:  # This opens the file in binary mode for writing
        file.write(changed_data)  # This writes the encrypted content back to the file.
...
def main():
    ...
    # This starts a loop for the user to keep using the script until they want to leave the script.
    while True:
